...
@DynamoDBTable(tableName = "flickapprebuild-mobilehub-1713547585-Locations")
...
public class LocationsDO {
    ...
    @DynamoDBIndexHashKey(attributeName = "category", globalSecondaryIndexNames = {"Categories","Location",})
    ...
    @DynamoDBIndexRangeKey(attributeName = "location", globalSecondaryIndexName = "Location")
